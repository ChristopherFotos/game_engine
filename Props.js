class Prop {
    constructor(scene, {shape, radius, width, stroke, fill, strokeColor, fillColor, height, x, y, fixedX, fixedY, speed, direction, 
        mass, solid, accelMag, friction, elasticity, minSpeed, collision, nograv, movement, movementArray, collisionArray, controls = [], bitmap} = {}){
